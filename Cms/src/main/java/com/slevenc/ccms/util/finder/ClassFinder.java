package com.slevenc.ccms.util.finder;
...
public class ClassFinder {
    ...
    private final static Logger logger = Logger.getLogger(ClassFinder.class.getName());

    private String[] packageList = {"com.slevenc"};
