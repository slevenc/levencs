 ...
 */
//xml 文件查找器 TODO 尚未实现
public class SpiderXmlFinder {

    private final static Logger logger = Logger.getLogger(SpiderXmlFinder.class.getName());
    ...
    private List<String> underClassPath(String resourcePath, String classPath, String ends) throws Exception {
        ...
        try {
            ...
            logger.log(Level.INFO, "jar文件读取失败:" + resourcePath, ex);
        } finally {
            if (jis != null) {
                jis.close();
            }
