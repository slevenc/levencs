package com.slevenc.classfinder;
...
public class SpiderClassFinder {

    private final static Logger logger = Logger.getLogger(SpiderClassFinder.class.getName());

    private String[] packageList = {"com.ehr"};
    ...
    public SpiderClassFinder() {
        try {
            ...
            logger.log(Level.INFO,"类列表构造失败", ex);
        }
    }
    ...
    private void classLoader(String p) throws Exception {
        ...
        for (String className : resources) {
            try {
                ...
                logger.log(Level.INFO,"class:"+className+";load Fail");
            }
